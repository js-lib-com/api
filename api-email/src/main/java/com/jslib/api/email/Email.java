 ...
 * <ul>
 * <li>{@link com.jslib.api.email.Email#to(String...) to} - mandatory list of email addresses for destinations; if this property is
 * missing email sending should fail,
 * <li>{@link com.jslib.api.email.Email#cc(String...) cc} - optional list of email addresses for copy carbon destinations,
 * <li>{@link com.jslib.api.email.Email#bcc(String...) bcc} - optional list of email addresses for blind copy carbon destinations,
 * <li>{@link com.jslib.api.email.Email#subject(String) subject} - email subject; this property is optional if email sender has
 * <code>js.email.subject</code> property,
 * <li>{@link com.jslib.api.email.Email#from(String) from} - originator email address; this property is optional if email sender
 * has <code>js.from.address</code> property,
 * <li>{@link com.jslib.api.email.Email#replyTo(String...) replyTo} - optional a list of email addresses where email reply should
 * be sent; if this property is missing sender uses <code>js.reply.to.address</code>, if any.
 * <li>{@link com.jslib.api.email.Email#envelopeFrom(String) envelopeFrom} - this is reverse path used by remote agent to send back
