 ...
 * </pre>
 * <p>
 * For a complete list of supported properties see {@link js.email.EmailSender} class description. Here is a sample
 ...
 * {@link js.email.EmailSender#getEmail(Locale, String)} to retrieve email instance.
 * 
 ...
 * a template and {@link js.email.Email} class has setters for properties. Optionally email can contain attached files,
 * see {@link js.email.Email#file(File...)}.
 * <p>
 ...
 * send method, see {@link js.email.Email#send(Object...)} accepts a user object and inject instance fields into
 ...
 * </pre>
 * <p>
 * For a full description of email instance properties see {@link js.email.Email}. If need to set many email properties,
 * like long list CC and BCC it is convenient to use email model base class, see {@link js.email.EmailModel}.
 * 
 * <pre>
