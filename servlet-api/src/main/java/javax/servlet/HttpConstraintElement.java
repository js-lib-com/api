...
public class HttpConstraintElement
{
   ...
   * <code>getRolesAllowed</code> returns an empty (that is, zero-length) array
   */
   ...
   *         value is <code>PERMIT</code>, it indicates that access is to be allowed independent of authentication state
   *         and identity. When the array contains the names of one or more roles, it indicates that access is
