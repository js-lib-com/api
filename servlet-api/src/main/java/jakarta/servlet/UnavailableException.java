...
{
  private static final long serialVersionUID = 2833605184628129217L;
   ...
   * not running, but not be able to report how long it will take to be restored to functionality. This can be indicated
   * with a negative or zero value for the <code>seconds</code> argument.
   *
   * @param msg a <code>String</code> specifying the descriptive message, which can be written to a log file or
   *          displayed for the user.
   *
