 ...
 * include <code>class</code> property before the actual object JSON stream.
 * <p>
...
public interface Json
{
   ...
   */
  void stringifyObject(Writer writer, Object value) throws IllegalArgumentException, IOException;
   ...
   */
  <T> T parseObject(Reader reader) throws IllegalArgumentException, IOException, JsonException, ClassCastException;
